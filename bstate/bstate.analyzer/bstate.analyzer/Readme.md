...
### bstate.analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [bstate.analyzer.Sample.csproj](../bstate.analyzer.Sample/bstate.analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### bstate.analyzer.Tests
