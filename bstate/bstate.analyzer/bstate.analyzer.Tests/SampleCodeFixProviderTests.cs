...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<bstate.analyzer.SampleSyntaxAnalyzer,
        bstate.analyzer.SampleCodeFixProvider>;

namespace bstate.analyzer.Tests;
